...
INSERT INTO dbo.SANPHAM (MASANPHAM, TENSANPHAM, GIABAN, SOLUONGTON, MANHOMSP, NUOCSX)
VALUES
...
INSERT INTO dbo.CHITIET_DDH (MADDH, MASANPHAM, NGAYDATHANG, SOLUONG, THANHTIEN)
VALUES
(   'DH005', 'SP010','2020-1-4', 3, NULL ),
(   'DH002', 'SP032','2020-12-24', 5, NULL ),
(   'DH004', 'SP022','2020-3-18', 15, NULL ),
(   'DH009', 'SP011','2021-4-2', 3, NULL ),
(   'DH005', 'SP007','2021-10-2', 3, NULL ),
(   'DH001', 'SP036','2021-9-25', 10, NULL ),
(   'DH006', 'SP017','2021-5-17', 30, NULL ),
(   'DH008', 'SP015','2021-4-4', 7, NULL ),
(   'DH002', 'SP038','2021-4-5', 10, NULL ),
(   'DH007', 'SP040','2020-9-9', 30, NULL )
