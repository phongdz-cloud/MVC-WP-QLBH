...
GO 
-- Chỉnh sửa bảng sản phẩm
ALTER TABLE dbo.ListImageSP WITH CHECK ADD CONSTRAINT FK_MASP FOREIGN KEY (MASANPHAM)
REFERENCES dbo.SANPHAM (MASANPHAM)
ON DELETE CASCADE
GO
ALTER TABLE dbo.SANPHAM DROP COLUMN NGAYSX,HANSD
...
GO
-- Sửa bảng chi tiết DDH
ALTER TABLE dbo.CHITIET_DDH ADD THANHTIEN INT
-- Cập nhật thành tiền Chitiet_DDH
UPDATE dbo.CHITIET_DDH
SET THANHTIEN =ct.SOLUONG*sp.GIABAN
FROM dbo.CHITIET_DDH ct JOIN dbo.SANPHAM sp ON sp.MASANPHAM = ct.MASANPHAM


-- -- Chỉnh form hóa đơn
ALTER TABLE dbo.HOADON WITH CHECK ADD CONSTRAINT FK_MAKH FOREIGN KEY (MAKHACHHANG)
